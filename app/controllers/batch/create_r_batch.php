...
$sql_total_events = "SELECT COUNT(*) AS total FROM reporte_batch";
...
$sql_select_events = "SELECT id_subprocess, id_details_batch, start_date, end_date, state FROM reporte_batch ORDER BY id_subprocess ASC LIMIT :offset, :records_per_page ";
